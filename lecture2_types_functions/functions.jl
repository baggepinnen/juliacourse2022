...
#### Arguments are passed by reference (technically, they are passed by "sharing")
...
#### And, when applied multiple times, the loops are guaranteed to be automatically fused!
